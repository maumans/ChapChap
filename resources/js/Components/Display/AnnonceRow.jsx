...
import {AccessTime, FavoriteOutlined, Place} from "@mui/icons-material";
...
function AnnonceRow({annonce}) {
    ...
    return (
        <div onClick={()=>showAnnonce(annonce.id)} className={'cursor-pointer h-52 w-auto hover:shadow-2xl transition duration-500 bg-gray-50 flex'}>
            <div className={'w-4/12 relative'}>
                <img src={annonce.image} alt="" className={'absolute w-full h-full object-cover z-0'}/>
            </div>
            <div className={"flex justify-between gap-2 items-end p-3 w-full"}>
                <div className={'px-3 py-1 h-full grid gap-2'}>
